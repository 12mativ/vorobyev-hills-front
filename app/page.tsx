...
export default function Page() {
  return (
    <div className="flex flex-col gap-y-2 justify-center items-center overflow-y-auto h-full p-2">
      ...
      <p className="text-white text-xl md:text-3xl mt-5 text-center">Кейс</p>
      <p className="text-white text-xl md:text-3xl underline text-center">Семантическая классификация документов</p>
